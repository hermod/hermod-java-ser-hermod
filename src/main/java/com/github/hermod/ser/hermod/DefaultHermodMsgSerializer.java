 ...
 * 
 */
public final class DefaultHermodMsgSerializer implements BytesMsgSerializer, ByteBufferMsgSerializer {

    private static final DefaultHermodMsgSerializer DEFAULT_MSG_SERIALIZER = new DefaultHermodMsgSerializer();
     ...
     * @return
     */
    public static DefaultHermodMsgSerializer create() {
     ...
     * @return
     */
    public static DefaultHermodMsgSerializer get() {
