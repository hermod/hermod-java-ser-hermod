...
public final class Demo {
    ...
    public static void main(String[] args) {
        ...
        //
        IndexedPrimitivesObjectsHermodMsg intMap = IndexedPrimitivesObjectsHermodMsg.createWithKeyMax(44);
        intMap.removeAll();
        intMap.set(0, 1.1, 1);
        intMap.set(1, 1.1, 1);
        intMap.set(2, 2.2, 1);
        ...
        IndexedPrimitivesObjectsHermodMsg intMap2 = IndexedPrimitivesObjectsHermodMsg.createWithKeyMax(44);
        ...
        intMap2 = IndexedPrimitivesObjectsHermodMsg.createWithKeyMax(44);
